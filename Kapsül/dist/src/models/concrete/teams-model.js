...
class TeamsModel {
    ...
    async GetTeamsByProductCode(entity) {
        let returnObject = null;
        let teams = null;
        ...
        try {
            returnObject = new generic_response_1.GenericResponse();
            let queryManager = (0, typeorm_1.getManager)();
            let responseGetTeamsByProductCodeResponse = await queryManager.query(teams_script_1.TeamsScript.selectTeamsByProductCode, [
                entity.productCode,
                entity.recived
            ]);
